        ...
        >
            <div className="max-w-7xl mx-auto glass-panel px-6 py-4 flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center gap-4">
                    ...
                    <button className="px-5 py-2 rounded-full bg-primary/10 border border-primary/50 text-primary text-xs font-bold tracking-widest hover:bg-primary/20 transition-all duration-300 uppercase glow-btn">
                        Sign Up
                    </button>
                </div>
            </div>
