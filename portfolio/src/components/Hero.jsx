...
const Hero = () => {
    ...
    return (
        <section className="relative min-h-[85vh] flex flex-col items-center justify-center text-center py-20 px-4 perspective-1000">
            ...
            >
                <a href="#signup" className="px-8 py-3 rounded-xl bg-accent text-black font-bold tracking-wide transition-all duration-300 shadow-[0_0_20px_rgba(75,255,179,0.3)] hover:shadow-[0_0_30px_rgba(75,255,179,0.5)] flex items-center justify-center gap-2 hover:scale-105">
